...
sentence002_content = (
	"Sie möchte, dass die Rechtschreibung in erster Linie dem Lesenden und Schreibenden "
	"hilft, einen Text möglichst einfach zu lesen bzw. zu erstellen.")
def sentence002():
...
sentence005_content = (
	"Die Überarbeitung des Regelsatzes hätte offensichtlich die zum Teil drastische "
	"Änderung des Schriftbildes zur Folge.")
def sentence005():
...
sentence009_content = (
	"Andererseits könnten sich Kinder schneller das Lesen und Schreiben aneignen, "
	"weil sie weniger Zeit mit dem Lernen überflüssiger und inkonsistenter Regeln "
	"verschwenden würden.")	
def sentence009():
