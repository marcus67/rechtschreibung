...
sentence001_content = (
	"Der grundlegende Unterschied ist ganz einfach: Casimir hat in seiner Jugend "
	"die damals aktuelle Rechtschreibung kennengelernt und hat sich an sie gewöhnt.")
def sentence001():
...
sentence005_content = (
	"Besonders störend sind dabei die Fälle, bei denen sich die Aussprache von Worten "
	"nicht aus dem Schriftbild ableiten lässt.")
def sentence005():
...
sentence006_content = (
		"Casimir möchte dennoch diesen althergebrachten Regelsatz erhalten und damit das "
		"Schriftbild, das ihm aus fast der gesamten heute verfügbaren Literatur vertraut ist.")	
def sentence006():
