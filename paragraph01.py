...
sentence002_content = (
	...
	"sehr stark abweichende Sichten auf die deutsche Rechtschreibung.")
def sentence002():
...
sentence003_content = (
	"Casimir ist eher konservativ und möchte am liebsten den Status Quo "
	"wiederherstellen, wie er vor der Rechtschreibreform im Jahre 1996 gültig war.")
def sentence003():
...
sentence004_content = (
	"Wendy ist eher fortschrittlich und überlegt ständig, "
	"wie man die Rechtschreibung verbessern und vereinfachen kann.")
def sentence004():
...
sentence005_content = (
	"Diese unterschiedlichen Sichtweisen führen ständig zu Diskussionen und "
	"Streitereien.")
def sentence005():
